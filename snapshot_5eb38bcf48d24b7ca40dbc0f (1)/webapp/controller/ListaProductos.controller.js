sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.inventarioHiFi.controller.ListaProductos", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("ListaProductos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_Responsive_Page_0-content-sap_m_StandardList-1588826486575",
				"groups": ["items"]
			}];
